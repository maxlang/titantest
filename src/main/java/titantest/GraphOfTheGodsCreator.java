...
/**
 * Example Graph factory that creates a {@link com.thinkaurelius.titan.core.TitanGraph} based on roman mythology.
 * Used in the documentation examples and tutorials.
 *
 * @author Marko A. Rodriguez (http://markorodriguez.com)
 */
public class GraphOfTheGodsCreator {
    ...
    public static TitanGraph create(final String directory) {
        ...
        GraphOfTheGodsCreator.load(graph);
        return graph;
    }
